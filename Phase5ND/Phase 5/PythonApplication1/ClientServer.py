...
if(option_choice == "Option 1" or option_choice == "option 1"):
    ...
    while True:
        ...
        while seq_num < base + window_size:
            ...
            if(seq_num >= len(output_image)): # We are at the end of our files so we must avoid indexing issues
                break
...
#**** Option 2 - ACK Corruption ****
    ...
    print(f"This is how many packets need to be sent: {num_of_packets_to_send}")
    while True:
        percent_error = input("Please select the percentage of ACK corruption you would like to be implemented(0-70 increments of 5 is the range): ")
        if percent_error in ["0", "5", "10", "15", "20", "25", "30", "35", "40", "45", "50", "55", "60", "65", "70"]:
            break
        else:
...
#**** Option 4 - ACK packet loss ****
    ...
    print(f"This is how many packets need to be sent: {num_of_packets_to_send}")
    while True:
        percent_error = input("Please select the percentage of ACK packet loss you would like to be implemented(0-70 increments of 5 is the range): ")
        if percent_error in ["0", "5", "10", "15", "20", "25", "30", "35", "40", "45", "50", "55", "60", "65", "70"]:
            break
        else:
            print("Invalid value, try again.")
...
#**** Option 5 - Data packet loss ****
    ...
    while True:
        percentage_loss = input("Please select the percentage chance of Data packet loss you would like to be implemented(0-70 increments of 5 is the range): ")
        if percentage_loss in ["0", "5", "10", "15", "20", "25", "30", "35", "40", "45", "50", "55", "60", "65", "70"]:
            break
        else:
